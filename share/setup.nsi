...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-Chingeling executable and locales:
...
Section -post SEC0001
    ...
    # Chingeling: URI handling disabled for 0.6.0
    #    WriteRegStr HKCR "Chingeling" "URL Protocol" ""
    #    WriteRegStr HKCR "Chingeling" "" "URL:Chingeling"
    #    WriteRegStr HKCR "Chingeling\DefaultIcon" "" $INSTDIR\Chingeling-qt.exe
    #    WriteRegStr HKCR "Chingeling\shell\open\command" "" '"$INSTDIR\Chingeling-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Chingeling.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\Chingeling.lnk"

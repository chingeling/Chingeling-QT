#ifndef ChingelingGUI_H
#define ChingelingGUI_H
...
/**
  Chingeling GUI main class. This class represents the main window of the Chingeling UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ChingelingGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit ChingelingGUI(QWidget *parent = 0);
    ~ChingelingGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Chingeling wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

...
#ifndef _ChingelingRPC_H_
#define _ChingelingRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Chingeling is not connected
...
/**
 * Chingeling RPC command dispatcher.
 */
class CRPCTable
{
private:

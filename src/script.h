...
#ifndef H_Chingeling_SCRIPT
#define H_Chingeling_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CChingelingAddress
 */
...
public:
    ...
    // Pre-version-0.6, Chingeling always counted CHECKMULTISIGs
